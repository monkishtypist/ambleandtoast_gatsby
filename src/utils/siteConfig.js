module.exports = {
  ...
  siteUrl: 'https://ambleandtoast.com', // Site domain. Do not include a trailing slash! If you wish to use a path prefix you can read more about that here: https://www.gatsbyjs.org/docs/path-prefix/
  postsPerHomePage: 7, // Number of posts shown on the 1st page of of the index.js template (home page)
  postsPerPage: 6, // Number of posts shown on paginated pages
  author: 'Amble + Toast', // Author for RSS author segment and SEO schema
  authorUrl: 'https://ambleandtoast.com/about/', // URL used for author and publisher schema, can be a social profile or other personal site
  ...
  copyright: 'Copyright © 2020 Little Finch Media', // Copyright string for the RSS feed
}
